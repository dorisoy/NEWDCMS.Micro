...
using DTPDapr;
using IApplicationService.DTPDaprs.CreateOrder;
...
namespace ApplicationService
{
    public class OrderUseCaseService : IOrderUseCaseService
    {
        ...
        private readonly IDTPDaprManager DTPDaprManager;
        public OrderUseCaseService(IOrderRepository repository, IAccountQueryService accountQueryService, IEventBus eventBus, IStateManager stateManager, IUnitofWork unitofWork, IGoodsQueryService goodsQueryService, IGoodsActorService goodsActorService, IDTPDaprManager DTPDaprManager)
        {
            ...
            this.DTPDaprManager = DTPDaprManager;
        }
        ...
        public async Task<ApiResult> CreateOrderByDTPDapr(OrderCreateDto input)
        {
            await DTPDaprManager.StartOrNext(Topics.GoodsHandler.PreDeductInventory, input);
