...
namespace Domain.Entities
{
    ...
    public class Logistics : Entity, IAggregateRoot
    {
        ...
        public void Deliver(int orderId, LogisticsType logisticsType, string logisticsNo, string deliverName, string deliverAddress, int deliverUserId, string receiverName, string receiverAddress, DateTime? deliveTime)
        {
            OrderId = orderId;
        ...
        public void Receive(int receiverUserId, DateTime? receiveTime)
        {
